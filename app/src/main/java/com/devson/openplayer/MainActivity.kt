...
import com.devson.openplayer.data.media.MediaStoreHelper
import com.devson.openplayer.data.repository.VideoRepository
import com.devson.openplayer.player.engine.MPVPlayerEngine
import com.devson.openplayer.ui.navigation.AppNavigation
import com.devson.openplayer.ui.theme.NosvedPlayerTheme
import com.devson.openplayer.viewmodel.HomeViewModel
import com.devson.openplayer.viewmodel.PlayerViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private val pipReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            when (intent.action) {
                "com.devson.openplayer.PIP_PREV" -> playerViewModel.playPrevious()
                "com.devson.openplayer.PIP_PLAY_PAUSE" -> {
                    playerViewModel.togglePlayback()
                    updatePipActions()
                }
                "com.devson.openplayer.PIP_NEXT" -> playerViewModel.playNext()
            }
        }
    }
    ...
    private fun buildPipActionsList(): List<android.app.RemoteAction> {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // 1. Prev Action
            val prevIntent = Intent("com.devson.openplayer.PIP_PREV")
            ...
            val playPauseIntent = Intent("com.devson.openplayer.PIP_PLAY_PAUSE")
            ...
            // 3. Next Action
            val nextIntent = Intent("com.devson.openplayer.PIP_NEXT")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = IntentFilter().apply {
            addAction("com.devson.openplayer.PIP_PREV")
            addAction("com.devson.openplayer.PIP_PLAY_PAUSE")
            addAction("com.devson.openplayer.PIP_NEXT")
        }
    ...
    private fun logExternalVideoHistory(uri: Uri) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val metadataResult = com.devson.openplayer.data.mediainfo.MediaInfoOps.extractBasicMetadata(
                    this@MainActivity,
                    uri,
                    fileName
                )
                ...
                val video = com.devson.openplayer.domain.model.Video(
                    uri = uri.toString(),
                    title = fileName,
                    duration = duration,
                    folderName = "",

...
import com.devson.openplayer.data.model.FolderItem
import com.devson.openplayer.data.model.VideoItem
...
class VideoRepository(
    ...
    val videoMetadataDao = com.devson.openplayer.data.database.AppDatabase.getDatabase(context).videoMetadataDao()
        ...
        trashedItems.map { item ->
            ...
            if (item.size > 0 && item.duration > 0) {
                ...
                if (cached != null) {
                    ...
                    val extracted = com.devson.openplayer.util.getVideoMetadata(context, item.uri)

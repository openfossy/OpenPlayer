package com.devson.openplayer.player.service
...
import com.devson.openplayer.MainActivity
...
class MediaPlaybackService : Service() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                ...
                ACTION_PREV -> {
                    val broadcastIntent = Intent("com.devson.openplayer.PIP_PREV").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
                ACTION_NEXT -> {
                    val broadcastIntent = Intent("com.devson.openplayer.PIP_NEXT").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_PLAYBACK = "com.devson.openplayer.ACTION_TOGGLE_PLAYBACK"
        const val ACTION_STOP = "com.devson.openplayer.ACTION_STOP"
        const val ACTION_PREV = "com.devson.openplayer.ACTION_PREV"
        const val ACTION_NEXT = "com.devson.openplayer.ACTION_NEXT"
        const val ACTION_REWIND = "com.devson.openplayer.ACTION_REWIND"
        const val ACTION_FORWARD = "com.devson.openplayer.ACTION_FORWARD"
    ...
    private fun updateNotification() {
        ...
        val metadataBuilder = MediaMetadataCompat.Builder()
            ...
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "Open Player")

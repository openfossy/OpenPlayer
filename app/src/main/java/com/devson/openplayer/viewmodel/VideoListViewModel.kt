...
import com.devson.openplayer.domain.model.StorageVolumeInfo
...
import com.devson.openplayer.util.getAvailableStorageVolumes
...
import com.devson.openplayer.ui.screens.videolist.state.PathSegment
...
class VideoListViewModel(
                    ...
                    val videos = items.map { item ->
                        ...
                        if (item.size > 0 && item.duration > 0) {
                            ...
                            if (cached != null) {
                                ...
                                val extracted = com.devson.openplayer.util.getVideoMetadata(repository.context, item.uri)
                                ...
                                metadataDao.insertOrUpdate(
                                    com.devson.openplayer.data.database.CachedVideoMetadata(
                                        uri = uriStr,
                                        size = finalSize,
    ...
    fun selectFolder(folder: VideoFolder?) {
        ...
        if (folder != null) {
            ...
            com.devson.openplayer.domain.thumbnail.ThumbnailRepository.getInstance(repository.context)

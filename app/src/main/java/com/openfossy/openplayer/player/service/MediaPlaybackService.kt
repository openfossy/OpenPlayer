package com.openfossy.openplayer.player.service
...
import com.openfossy.openplayer.MainActivity
...
class MediaPlaybackService : Service() {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                ...
                ACTION_PREV -> {
                    val broadcastIntent = Intent("com.openfossy.openplayer.PIP_PREV").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
                ACTION_NEXT -> {
                    val broadcastIntent = Intent("com.openfossy.openplayer.PIP_NEXT").apply {
                        setPackage(packageName)
                    }
                    sendBroadcast(broadcastIntent)
                }
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_PLAYBACK = "com.openfossy.openplayer.ACTION_TOGGLE_PLAYBACK"
        const val ACTION_STOP = "com.openfossy.openplayer.ACTION_STOP"
        const val ACTION_PREV = "com.openfossy.openplayer.ACTION_PREV"
        const val ACTION_NEXT = "com.openfossy.openplayer.ACTION_NEXT"
        const val ACTION_REWIND = "com.openfossy.openplayer.ACTION_REWIND"
        const val ACTION_FORWARD = "com.openfossy.openplayer.ACTION_FORWARD"

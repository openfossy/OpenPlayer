package com.openfossy.openplayer.ui.screen.videolist
...
import com.openfossy.openplayer.ui.components.CustomRenameDialog
import com.openfossy.openplayer.ui.common.components.PreviewFloatingActionButton
import androidx.lifecycle.Lifecycle
import androidx.lifecycle.LifecycleEventObserver
import androidx.lifecycle.compose.LocalLifecycleOwner
import com.openfossy.openplayer.ui.common.sheets.ViewSettingsBottomSheet
import com.openfossy.openplayer.ui.screen.videolist.components.folder.FolderListContent
import com.openfossy.openplayer.ui.common.sheets.InformationBottomSheet
import com.openfossy.openplayer.ui.screen.StorageExplorerScreen
import com.openfossy.openplayer.ui.screens.videolist.components.topbar.VideoListTopAppBar
import com.openfossy.openplayer.ui.screen.videolist.components.video.VideoListContent
import com.openfossy.openplayer.ui.screens.videolist.components.explorer.ExplorerListContent
import com.openfossy.openplayer.ui.screens.videolist.components.explorer.ExplorerPathStrip
import com.openfossy.openplayer.ui.screens.videolist.components.selection.VideoSelectionBottomBar
import com.openfossy.openplayer.ui.screens.videolist.utils.applyFolderSort
import com.openfossy.openplayer.ui.screens.videolist.utils.shareVideos
import com.openfossy.openplayer.ui.common.components.SelectionBottomAppBar
...
fun VideoListScreen(
    ...
    val mostRecentPlayedUri = remember(historyMap) {
        historyMap.values
                            ...
                            AnimatedContent(
                                ...
                                if (folder == null) {
                                    FolderListContent(
                                        ...
                                        mostRecentPlayedUri = mostRecentPlayedUri,
    ...
    if (showInfoBottomSheet && isSelectionActive) {
        if (selectedFolders.isNotEmpty() && selectedVideos.isEmpty()) {
            com.openfossy.openplayer.ui.screen.videolist.components.folder.FolderInfoDialog(
                selectedFolders = selectedFolders,
                videosByFolder = videosByFolder,

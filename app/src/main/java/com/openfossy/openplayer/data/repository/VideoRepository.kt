...
import com.openfossy.openplayer.data.model.FolderItem
...
class VideoRepository(
    ...
    val videoMetadataDao = com.openfossy.openplayer.data.database.AppDatabase.getDatabase(context).videoMetadataDao()
        ...
        trashedItems.map { item ->
            ...
            if (item.size > 0 && item.duration > 0) {
                ...
                if (cached != null) {
                    ...
                    val extracted = com.openfossy.openplayer.util.getVideoMetadata(context, item.uri)
